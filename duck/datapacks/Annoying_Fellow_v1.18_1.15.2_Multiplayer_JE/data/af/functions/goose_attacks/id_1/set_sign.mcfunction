...
execute if score rand_2 af.1.global matches 0 run setblock ~ ~ ~ oak_sign[rotation=0] destroy
execute if score rand_2 af.1.global matches 1 run setblock ~ ~ ~ oak_sign[rotation=1] destroy
execute if score rand_2 af.1.global matches 2 run setblock ~ ~ ~ oak_sign[rotation=2] destroy
execute if score rand_2 af.1.global matches 3 run setblock ~ ~ ~ oak_sign[rotation=3] destroy
execute if score rand_2 af.1.global matches 4 run setblock ~ ~ ~ oak_sign[rotation=4] destroy
execute if score rand_2 af.1.global matches 5 run setblock ~ ~ ~ oak_sign[rotation=5] destroy
execute if score rand_2 af.1.global matches 6 run setblock ~ ~ ~ oak_sign[rotation=6] destroy
execute if score rand_2 af.1.global matches 7 run setblock ~ ~ ~ oak_sign[rotation=7] destroy
execute if score rand_2 af.1.global matches 8 run setblock ~ ~ ~ oak_sign[rotation=8] destroy
execute if score rand_2 af.1.global matches 9 run setblock ~ ~ ~ oak_sign[rotation=9] destroy
execute if score rand_2 af.1.global matches 10 run setblock ~ ~ ~ oak_sign[rotation=10] destroy
execute if score rand_2 af.1.global matches 11 run setblock ~ ~ ~ oak_sign[rotation=11] destroy
execute if score rand_2 af.1.global matches 12 run setblock ~ ~ ~ oak_sign[rotation=12] destroy
execute if score rand_2 af.1.global matches 13 run setblock ~ ~ ~ oak_sign[rotation=13] destroy
execute if score rand_2 af.1.global matches 14 run setblock ~ ~ ~ oak_sign[rotation=14] destroy
execute if score rand_2 af.1.global matches 15 run setblock ~ ~ ~ oak_sign[rotation=15] destroy
